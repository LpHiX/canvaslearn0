...
var test = document.createElement("canvas") as HTMLCanvasElement;
...
var cont = test.getContext("2d") as CanvasRenderingContext2D;
...
function getColor(uv: Vec3, texture: ImageData): Vec3{
...
function drawTriangle(vert0: Vertex, vert1: Vertex, vert2: Vertex, texture: ImageData){
