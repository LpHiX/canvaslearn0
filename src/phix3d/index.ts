...
import { Cube } from "./object3d.js";

const canvas0 = document.getElementById("canvas0") as HTMLCanvasElement;
const ctx = canvas0.getContext("2d") as CanvasRenderingContext2D;
...
var world0 = new World([testBlock0,testBlock1,testBlock2, testBlock3]);
