...
const cam0cube = new Cube(new Vec3(0.1, 0.1, 0.1), new Vec3( 1, 2, 1), false, "rgb(255, 255 ,255)");
const cam1cube = new Cube(new Vec3(0.1, 0.1, 0.1), new Vec3( 1, 2, 1), false, "rgb(255, 255 ,255)");
...
function frameUpdate(timestamp:number){
    ...
    viewport1.drawWorld(world0, null);
